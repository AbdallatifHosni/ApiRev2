...
namespace Day1
{
    public class Startup
    {
        ...
        //depence injection ioc container ==>servicePRovider
        ...
        { 
            ...
            services.AddDbContext<ITIEnitities>(options => 
                options.UseSqlServer("Data Source=.;Initial Catalog=ITI_DB;Integrated Security=True"));
            
            //register my custom service "your class "
            //services.AddSingleton<typesource,Type create instance>
            services.AddScoped<IStudentRepository, StudentRepository>();//register IStudent
